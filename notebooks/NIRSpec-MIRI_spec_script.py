...
#source = 'NGC7469'
#source = 'IIZw096'
source = 'NGC3256_JWST_PAH'

# Read parameter file with extraction keywords
creta_dir = '../../CRETA/'
pf = open(creta_dir+'param_files/'+source+'_single_params.txt','r')
print(pf.read())
pf.close()
...
c.singleExtraction(parameter_file=True, perband_cent=True, parfile_name=source+'_single_params.txt', data_path='../../CRETA/data/NGC3256/', output_filebase_name=source)
